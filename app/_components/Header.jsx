...
return (<header className={` ${theme=="dark"? " bg-gray-900 ":"bg-gray-200 text-gray-900" }  text-gray-400 body-font shadow-lg w-full`}>
    <div className="container mx-auto flex flex-wrap p-5 justify-between items-center md:flex-row ">
      ...
      <nav className="md:mr hidden  md:flex md-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	 flex-wrap items-center text-base justify-center">
        <a className={`  ${theme=="dark" ? " ": "hover:text-black" } mr-5 cursor-pointer`}>First Link</a>
        {/* <a className="mr-5 hover:text-white">Second Link</a>
        <a className="mr-5 hover:text-white">Third Link</a>
        <a className="mr-5 hover:text-white">Fourth Link</a> */}
      </nav>
      <div className={` ${theme=="light" ? " " :""}  inline-flex items-center  border-0  focus:outline-none   text-base  md:mt-0 cursor-pointer `}  >{isLoading ? "Login": <AccountMenu title={email}/> }
